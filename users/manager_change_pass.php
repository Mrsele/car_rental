...
<?php
?>
   <h3> OLd password</h3><input type="password"  placeholder="Enter Your OLd Password"name="oldpass" required><br><br>

   <h3> New Password </h3><input type="password" placeholder="Enter new password"name="newpass" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"><br><br>
   <h3> Confirm Pass </h3><input type="password" placeholder="Conform Password" name="confrirmpass"required><br><br>
